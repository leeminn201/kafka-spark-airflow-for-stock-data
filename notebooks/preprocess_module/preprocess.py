...
df = spark.read.options(header='True',inferSchema='True',delimiter=',')\
    .csv('../../spark/resources/data/dataset/raw.csv')

df = df.drop("_c0")
    
testData = _fully_preprocess(df)
